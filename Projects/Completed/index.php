...
<!-- End Google Tag Manager (noscript) -->
	...
	<header>
		...
		<div class="banner aboutus" data-bg-target="../../wccontent/images/04.jpg">
	...
	<section>
		<div class="section">
			<div class="container-pack thumbsliderTitle">
			...
			<div id="thumbslider">
				...
				<div class="slider">
                	<a href="vishwahans/" class="card">
						<img src="../../wccontent/images/Vishwa-Hans-logo.png" alt="Vishwa Green Realtors - Hans">
						<div class="row title">Hans - Kharghar</div>
					</a>
					<a href="vishwasiyona/" class="card">
						<img src="../../wccontent/images/Vishwa-Siyona-logo.png" alt="Vishwa Green Realtors - Siyona">
						<div class="row title">Vishwa Siyona -Ulwe</div>
					</a>
				</div>
				<div class="right">
					<span class="arrow"></span>
...
<script type="text/javascript">
	$("#slider").css({
		height:1381*parseInt($("body").width())/1920
	})

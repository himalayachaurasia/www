...
<!-- End Google Tag Manager (noscript) -->
	...
	<div style="display: flex; width: 100%; height: 70vh; flex-direction: column; justify-content: center; align-items: center; align-content: center;">
		...
		<a href="http://www.vishwagreenrealtors.com/Projects/Ongoing/plan-m/index.php" style="display: inline-block; background-color: #008040; color:#fff; padding: 10px; border-radius: 5px; text-decoration: none; ">Go Back to Plan M</a>
	</div>
	<?php
	}
	else if(isset($_POST['career'])) {
